...
int extended_copy_mirror_check(struct tdisk *src_tdisk, struct qsio_scsiio *ctio, struct tdisk *dest_tdisk, uint64_t src_lba, uint64_t dest_lba, uint32_t num_blocks, int *mirror_enabled, int *use_refs, uint32_t *xchg_id);
