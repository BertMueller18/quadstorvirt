...
#define M_CLONE_DATA		0
#define M_CLONE_THR		0
#define M_CLONE_INFO		0
#define M_REPLICATION		0
#define M_GROUP_BMAP		0
#define M_WLIST			0
#define M_PAGE_LIST		0
#define M_PGLIST		0
#define M_SENSEINFO		0
#define M_CTIODATA		0
#define M_NODE_RMSG		0
#define M_BINDEX		0
#define M_BINT			0
...
#define M_RCACHE		0
#define M_RCACHEBIO		0
#define M_RTRANS		0
#define M_DEVQ			0
#define M_SDEVQ			0
#define M_SCSIREQUEST		0
#define M_SGLIST		0
#define M_WRKMEM		0
#define M_TABLEINDEX		0
#define M_AMAPTABLEGROUP	0
#define M_INDEXGROUP		0
#define M_DDTABLE		0
#define M_DDBLOCK_INFO		0
#define M_PGDATA_POST		0
#define M_LOG_INFO		0
#define M_LOG_CONT		0
#define M_ECOPY			0
...
void sys_memset(void *dest, int c, int size);
...
#define ctio_bio_aligned		(*kcbs.ctio_bio_aligned)
#define ctio_map_bio			(*kcbs.ctio_map_bio)
#define copy_in_request_buffer		(*kcbs.copy_in_request_buffer)
#define copy_in_request_buffer2		(*kcbs.copy_in_request_buffer2)
#endif
